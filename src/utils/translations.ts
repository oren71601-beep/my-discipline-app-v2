...
export const TRANSLATIONS: Record<LanguageCode, TranslationDictionary> = {
  he: {
    ...
    monetizationHeaderSub: 'סמלץ את מודל המנוי שלך בחנויות האפליקציות ($10 לחודש):',
    ...
    paywallUnlockBtn: '⚡ שחרר פרימיום ב-$9.99 לחודש',
    ...
    paywallBtnStart: '⚡ התחל מנוי עכשיו ($9.99/חודש)',
    ...
    guideSub: 'מדריך מעשי שלב-אחר-שלב להפיכת קוד ה-Vite שלך לאפליקציית iOS/Android עם מנוי $10',
    guideModelTitle: 'איך המודל העסקי עובד בפועל?',
    guideModelDesc: 'משתמשים מורידים את האפליקציה בחינם מה-App Store. הם יכולים למלא את טבלת העסקאות היומית הבסיסית שלהם, אך ברגע שהם מנסים לצפות בגרפי האנליטיקה, בלוח השנה הויזואלי, או לייצא/לייבא קבצים, האפליקציה מציגה להם את דף הרכישה (Paywall) המאובטח לרכישת מנוי חודשי ב- 10$ בחודש.',
    ...
    guideStep3Desc: 'כדי לחייב את המשתמשים ב-$10 לחודש, אנו מגדירים פריט מנוי מתחדש ב-App Store Connect וב-Google Play Console:',
  ...
  en: {
    ...
    monetizationHeaderSub: 'Simulate your App Store subscription model ($10/month):',
    ...
    paywallUnlockBtn: '⚡ Unlock Premium for $9.99/mo',
    ...
    paywallBtnStart: '⚡ Subscribe Now ($9.99/month)',
    ...
    guideSub: 'Step-by-step framework to wrap your Vite project into a $10/mo iOS & Android App',
    guideModelTitle: 'How does the business model work?',
    guideModelDesc: 'Users download the app for free. They can record standard daily logs, but when accessing advanced charts, the mental calendar, or file import/export, the app prompts a conversion screen (Paywall) to purchase a $9.99/month subscription.',
  ...
  ar: {
    ...
    monetizationHeaderSub: 'قم بمحاكاة نموذج الاشتراك الشهري لتطبيقات الجوال (10$ شهرياً):',
    ...
    paywallUnlockBtn: '⚡ افتح باقة بريميوم بـ $9.99 شهرياً',
    ...
    paywallBtnStart: '⚡ اشترك الآن ($9.99/شهرياً)',
    ...
    guideModelDesc: 'يقوم المستخدمون بتنزيل التطبيق مجاناً. يمكنهم استخدام الجدول اليومي الأساسي، ولكن عند محاولة فتح الرسوم البيانية المتطورة، أو التقويم النفسي، أو استيراد وتصدير الملفات، يعرض التطبيق شاشة شراء (Paywall) للاشتراك بمبلغ 10 دولارات شهرياً.',
  ...
  ru: {
    ...
    monetizationHeaderSub: 'Эмулируйте подписочную модель в App Store / Google Play ($10/мес):',
    ...
    paywallUnlockBtn: '⚡ Разблокировать Премиум за $9.99/мес',
    ...
    paywallBtnStart: '⚡ Оформить Подписку ($9.99/месяц)',
    ...
    guideModelDesc: 'Пользователи скачивают приложение бесплатно. Они могут заполнять базовую таблицу сделок, но при попытке открыть аналитику, ментальный календарь или экспортировать бэкапы, приложение показывает экран оплаты (Paywall) за $9.99/месяц.',
