          ...
          {activeTab === 'terms' && (
            <div className="space-y-5 animate-fade-in">
              ...
              <section className="space-y-2">
                ...
                <p>
                  הסליקה מתבצעת באמצעות ספקי סליקה מורשים ומאובטחים העומדים בתקן המחמיר PCI-DSS (כגון iCount בישראל או Payoneer בזירה הבינלאומית). פרטי כרטיס האשראי אינם נשמרים בשרתי האתר אלא מעובדים ישירות בסביבת הסליקה המאובטחת של ספק התשלום.
                </p>
              </section>
